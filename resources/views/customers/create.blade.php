...
@section('header-actions')
    <a href="{{ route('customers.index') }}" class="text-sm text-gray-500 hover:text-gray-700">← Cancel</a>
@endsection
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="col-span-2">
                ...
                <textarea name="address" rows="2"
                          class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-600">{{ old('address') }}</textarea>
            </div>
            <div>
