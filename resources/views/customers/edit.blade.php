...
<div class="bg-white rounded-lg border border-gray-200 p-6 max-w-2xl">
    <form method="POST" action="{{ route('customers.update', $customer) }}" class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="col-span-2">
                ...
                <textarea name="address" rows="2"
                          class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-600">{{ old('address', $customer->address) }}</textarea>
            </div>
            <div>
        ...
        <div class="flex gap-3 pt-2">
            ...
            <a href="{{ route('customers.show', $customer) }}" class="nrh-btn nrh-btn-ghost">
                Cancel
            </a>
        </div>
    </form>
